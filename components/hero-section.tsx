      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-40">
        ...
        >
          <form onSubmit={handleSearch}>
            <div className="flex flex-col gap-3 rounded-2xl border border-border bg-card p-3 shadow-lg sm:flex-row sm:items-center">
              ...
              <Button
                type="submit"
                className="rounded-xl bg-primary px-8 py-6 text-sm font-semibold text-primary-foreground hover:bg-primary/90"
              >
