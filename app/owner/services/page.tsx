                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full rounded-xl border border-border bg-card px-3.5 py-2 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                      />
                    </div>
                    ...
                    <label className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-sm text-foreground">Aktiv (für Kunden buchbar)</span>
                    </label>
